...
<div class="container">
<h2 class="mt-5 mb-4">ようこそ! <c:out value="${login.userId}" />様</h2>
<a href="/weatherReport/ManagementServlet">管理画面へ</a>
<a class="mar" href="/weatherReport/WelcomeServlet">ホーム画面へ戻る</a>
</div>
</body>
</html>